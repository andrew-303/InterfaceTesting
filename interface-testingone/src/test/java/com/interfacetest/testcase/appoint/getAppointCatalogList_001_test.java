...
@Epic("appoint")
public class getAppointCatalogList_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointCatalogList_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("根据地点获取预约类型列表（需要依赖登录接口获取token）") 
	public void getAppointCatalogList(Map<String, String> data) { 

...
@Epic("appoint")
public class getAppointmentList_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointmentList_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("获取预约列表（预约中列表和历史预约列表）（需要依赖登录接口获取token）") 
	public void getAppointmentList(Map<String, String> data) { 

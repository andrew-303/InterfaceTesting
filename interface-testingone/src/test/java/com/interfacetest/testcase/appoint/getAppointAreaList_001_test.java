...
@Epic("appoint")
public class getAppointAreaList_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointAreaList_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("获取地点列表（需要依赖登录接口获取token）") 
	public void getAppointAreaList(Map<String, String> data) { 

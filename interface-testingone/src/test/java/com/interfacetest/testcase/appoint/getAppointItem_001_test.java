...
@Epic("appoint")
public class getAppointItem_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointItem_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("根据id获取预约事项（需要依赖登录接口获取token）") 
	public void getAppointItem(Map<String, String> data) { 

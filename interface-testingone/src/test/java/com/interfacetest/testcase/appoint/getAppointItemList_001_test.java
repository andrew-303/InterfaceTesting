...
@Epic("appoint")
public class getAppointItemList_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointItemList_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("根据类型获取事项列表（需要依赖登录接口获取token）") 
	public void getAppointItemList(Map<String, String> data) { 

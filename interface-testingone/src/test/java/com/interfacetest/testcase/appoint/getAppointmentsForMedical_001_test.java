...
@Epic("appoint")
public class getAppointmentsForMedical_001_test extends BaseParpare { 
 static Logger logger = Logger.getLogger(getAppointmentsForMedical_001_test.class.getName());
 
	@Test(dataProvider = "testData") 
	@Description("获取医疗预约列表（需要依赖登录接口获取token）") 
	public void getAppointmentsForMedical(Map<String, String> data) { 
